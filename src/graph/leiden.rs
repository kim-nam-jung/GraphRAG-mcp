...
impl LeidenNative {
    ...
    pub fn calculate(&mut self) -> Result<HashMap<String, u32>> {
        info!(
            "Running Leiden community detection clustering on {} nodes...",
        ...
        let result = leiden
            .run(&self.graph)
            .map_err(|e| anyhow::anyhow!("Leiden execution failed: {e:?}"))?;
        ...
        info!(
            "Identified {} basic communities. Quality: {:.4}",
